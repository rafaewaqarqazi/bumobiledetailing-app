...
import { FormItem, Paragraph, Title } from "@/components/antd-sub-components";
  ...
  return (
    <div>
      <div className="max-h-[400px] overflow-y-auto">
        ...
        <Paragraph>
          By booking or using BU Mobile Detailing Mobile {`Detailing’s`}{" "}
          services, you (“Client” or “You”) agree to the following terms and
          conditions, which constitute a legal agreement between you and BU
          Mobile Detailing LLC (“Contractor”, “We”, “Us”, or “Our”).
        </Paragraph>
        ...
        <ul>
          ...
          <li>
            Client not present or vehicle unable to be detailed upon arrival:
            Full service amount charged up to $250
          </li>
          <li>
        ...
        <Paragraph>
          BU Mobile Detailing reserves the right to arrive up to 120 minutes
          late. Sometimes job schedules are tight and we may need to push your
        ...
        <Paragraph>
          ...
          services such as detailing, ceramic coating, tinting, wrap, wet
          sanding, and other cosmetic enhancement services. BU Mobile Detailing
          endeavors to perform services to a high standard, aiming for a clean,
          damage-free exterior and spotless interior. Any concerns must be
          communicated within 24 hours of service completion. BU Mobile
          Detailing is not liable for concerns raised thereafter or if you do
          not participate in the final inspection.
        </Paragraph>
        <Title level={4}>
          Accidents, Pre-Existing Conditions & Limitation Of Liability
        </Title>
        <Paragraph>
          BU Mobile Detailing will document pre-existing damage but is not
          liable for pre-existing conditions. If damage occurs under BU Mobile
          {`Detailing’s`} care, you will be notified. BU Mobile Detailing
          provides no guarantees or warranties. Our maximum liability is limited
          to the amount you paid for the service giving rise to the claim. BU
          Mobile Detailing is not liable for any indirect, incidental, special,
        ...
        <Paragraph>
          ...
          detailing. You are responsible for any health/safety issues arising
          from your vehicle.
        </Paragraph>
        <Title level={4}>Feedback, Termination & Governing Law</Title>
        <Paragraph>
          We welcome your feedback at hellow@bumobiledetailing.com. By booking
          our services, you agree that BU Mobile Detailing may use pictures of
          your vehicle for marketing purposes unless you object in writing. This
          ...
          to these terms on behalf of the vehicle’s legal owner and are 18+
          years of age. You agree to indemnify and hold BU Mobile Detailing
          harmless from any claims or damages arising from your lack of
          authority to enter into this agreement.
        </Paragraph>
        <Title level={4}> Mandatory Gratuity Fee</Title>
        <Paragraph>
          If the Client does not show up for the final quality control check and
          inspection at the end of the job, a mandatory gratuity fee of 10% of
          the total service cost will be added to the invoice. This fee is
        ...
        <ul>
          ...
          <li>
            BU Mobile Detailing limits its liability to the total dollar amount
            of each job.
          </li>
          <li>
            ...
            the total cost at the discretion of BU Mobile Detailing employees
            (We will ask you before proceeding with extra charge).
          </li>
      ...
      >
        <Checkbox>
          I have read and agree to the BU Mobile Detailing Service Agreement
        </Checkbox>
      </FormItem>
    </div>
  );
